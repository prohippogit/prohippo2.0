...
const friendly = (code) => {
  const map = {
    ...
    "auth/unauthorized-domain": "This site's domain isn't authorized. Add prohippo.in in Firebase console → Authentication → Settings → Authorized domains.",
    "auth/unauthorized-continue-uri": "This site's domain isn't authorized for email links. Add prohippo.in in Firebase console → Authentication → Settings → Authorized domains.",
