/* ProHippo — vector PDF ledgers & payment receipts (jsPDF).
   ...
   payment receipt. */
import { amountInWords, fmtRupee } from "./invoicePdf.js";
/* The frame — rounded panels, the brand header, the footer, the palette — is
   shared with every other document the practice sends out. See pdfTheme.js. */
import {
  themedDoc, clipText, drawBrandHeader, drawFooter,
  hexToRgb, tint, readable, fmtDate, today,
  INK, BODY, MUTED, LINE, DEBIT, CREDIT,
} from "./pdfTheme.js";
